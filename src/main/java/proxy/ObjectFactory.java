...
public class ObjectFactory {
    ...
    private static final QName _Convertion_QNAME = new QName("http://ws/", "convertion");
    private static final QName _ConvertionResponse_QNAME = new QName("http://ws/", "convertionResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "convertion")
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "convertionResponse")
